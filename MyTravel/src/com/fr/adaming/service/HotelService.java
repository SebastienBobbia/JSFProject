...
public class HotelService {
	...
	public void init() {
		...
		listHotel
				.add(new Hotel("Belle Vue ***", "France", "Lannion", 60, false,
						true, true, "http://localhost:8080/MyTravel/photo4.jpg"));
		listHotel.add(new Hotel("Hotel des Bains **", "France", "La Ciotat",
				59.99, false, true, true,
				"http://localhost:8080/MyTravel/photo2.jpg"));
		listHotel.add(new Hotel("Camping des Pins ***", "France", "Trebeurden",
				25, false, true, true,
				"http://localhost:8080/MyTravel/camping1.jpg"));
		listHotel
				.add(new Hotel("Le Victoria ***", "France", "Cassis", 72.50,
						false, true, true,
						"http://localhost:8080/MyTravel/photo0.jpg"));
		listHotel
				.add(new Hotel("Le Golden Oak ****", "France", "Aubagne", 80,
						true, false, true,
						"http://localhost:8080/MyTravel/photo1.jpg"));
		listHotel.add(new Hotel("Grand Hotel du parc ***", "France",
				"Marseille", 75.50, false, false, true,
				"http://localhost:8080/MyTravel/photo5.jpg"));
		listHotel
				.add(new Hotel("Le Graziela ***", "France", "Doizieux", 38,
						false, true, true,
						"http://localhost:8080/MyTravel/photo6.jpg"));
		listHotel.add(new Hotel("Le Longchamp ****", "France", "Biscarosse",
				45, false, false, true,
				"http://localhost:8080/MyTravel/photo7.jpg"));
		listHotel.add(new Hotel("Hotel de l'Océan ***", "France", "Martigues",
				28, false, true, true,
				"http://localhost:8080/MyTravel/photo3.jpg"));
		listHotel.add(new Hotel("Camping Les vagues ***", "France", "Bayonne",
				22, true, true, true,
				"http://localhost:8080/MyTravel/camping0.jpg"));
		...
		listHotel.add(new Hotel("Manava***", "Tahiti", "Mahaena", 53.2, false,
				true, true, "http://localhost:8080/MyTravel/photo1.jpg"));

		listHotel.add(new Hotel("Tianzi ***", "Chine", "Shangai", 80.2, false,
				true, true, "http://localhost:8080/MyTravel/photo4.jpg"));
		listHotel.add(new Hotel("Love Hotel ****", "Chine", "Shangai", 90.5,
				true, true, true, "http://localhost:8080/MyTravel/photo6.jpg"));
		listHotel.add(new Hotel("Batman ***", "Chine", "Taiwan", 110, false,
				true, true, "http://localhost:8080/MyTravel/photo3.jpg"));
		listHotel.add(new Hotel("Royal View ****", "Chine", "Taizhou", 85,
				true, true, true, "http://localhost:8080/MyTravel/photo7.jpg"));
		listHotel.add(new Hotel("L'empereur **", "Chine", "Taizhou", 60, false,
				true, true, "http://localhost:8080/MyTravel/photo0.jpg"));
		listHotel.add(new Hotel("Village vacances ***", "Chine", "Taiwan", 70,
				false, true, true,
				"http://localhost:8080/MyTravel/camping0.jpg"));
		listHotel
				.add(new Hotel("Le Shenzen ***", "Chine", "Hong-Kong", 55.5,
						false, true, true,
						"http://localhost:8080/MyTravel/photo1.jpg"));
		listHotel
				.add(new Hotel("Bonham Hotel ***", "Chine", "Hong-Kong", 66,
						false, true, true,
						"http://localhost:8080/MyTravel/photo2.jpg"));
		listHotel
				.add(new Hotel("Shūshì de ji�? **", "Chine", "Hong-Kong", 55,
						false, true, true,
						"http://localhost:8080/MyTravel/photo5.jpg"));
		listHotel.add(new Hotel("Lǜsè l�?ngyù ***", "Chine", "Hong-Kong", 65.9,
				false, true, true,
				"http://localhost:8080/MyTravel/campingchine.jpg"));

		listHotel.add(new Hotel("Kényelmes otthon ***", "Autriche",
				"Thumersbach", 75, false, true, true,
				"http://localhost:8080/MyTravel/photo1.jpg"));
		listHotel.add(new Hotel("Fenyők ***", "Autriche",
		...
		listHotel.add(new Hotel("Le Rissman ****", "Autriche",
				...
				"http://localhost:8080/MyTravel/photo5.jpg"));
		listHotel.add(new Hotel("Faház ***", "Autriche", "Salzbourg", 55, true,
				true, true, "http://localhost:8080/MyTravel/photo2.jpg"));
		...
		listHotel.add(new Hotel("Camping des Sapins ***", "Autriche", "Vienne",
				55, false, true, true,
				"http://localhost:8080/MyTravel/camping3.jpg"));
		listHotel.add(new Hotel("Camping Zell am See **", "Autriche",
				"Zell am See", 53.2, true, true, true,
				"http://localhost:8080/MyTravel/camping0.jpg"));
		listHotel
				.add(new Hotel("St Georg***", "Autriche", "Thumersbach", 65,
						false, true, true,
						"http://localhost:8080/MyTravel/photo0.jpg"));
		listHotel
				.add(new Hotel("Seevilla****", "Autriche", "Vienne", 80, false,
						true, true, "http://localhost:8080/MyTravel/photo7.jpg"));

		listHotel.add(new Hotel("L'Aguirre ****", "Espagne", "Bilbao", 75,
				true, true, true, "http://localhost:8080/MyTravel/photo3.jpg"));
		listHotel
				.add(new Hotel("En Alcaraz ***", "Espagne", "Bilbao", 62, true,
						false, true,
						"http://localhost:8080/MyTravel/photo4.jpg"));
		...
		listHotel.add(new Hotel("Madison ****", "Espagne", "Almeria", 72.50,
				true, true, true, "http://localhost:8080/MyTravel/photo0.jpg"));
